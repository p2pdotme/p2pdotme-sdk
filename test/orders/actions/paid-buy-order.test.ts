...
import { createPaidBuyOrderAction } from "../../../src/orders/actions/paid-buy-order";

const DIAMOND = "0x000000000000000000000000000000000000beef" as const;

describe("paidBuyOrder.prepare", () => {
	const action = createPaidBuyOrderAction({
		publicClient: {} as never,
		diamondAddress: DIAMOND,
	});

	it("returns to/data/value that decode to paidBuyOrder(orderId)", async () => {
		...
		expect(decoded.functionName).toBe("paidBuyOrder");
